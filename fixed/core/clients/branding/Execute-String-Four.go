...
func TermFXExecuteBannerCustomFour(name string, conn *ssh.ServerConn, channel ssh.Channel, tagOne string, replaceOne string, tagTwo string, replaceTwo string, tagThree string, replaceThree string, tagFour string, replaceFour string) error {
	...
	New.RegisterVariable(tagOne, replaceOne)
	New.RegisterVariable(tagTwo, replaceTwo)
	New.RegisterVariable(tagThree, replaceThree)
	New.RegisterVariable(tagFour, replaceFour)
